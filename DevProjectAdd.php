...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "projadd")) {
  ...
  $insertGoTo = "../Jiloa/Development/DevProjectView.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$evproject = mysql_query($query_evproject, $development) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="projadd">  
  <tr>
    <td><a href="../Development/DevProjectView.php">View</a></th>
