...
if (isset($_POST['MM_Insert']) AND $_POST['MM_Insert']  == 'formphp')  {
  ...
  $Result1 = mysql_query($insertSQL, $development) or die(mysql_error());
}
...
$folderselect  = mysql_query($query_folderselect , $development) or die(mysql_error());
...
$phpselect  = mysql_query($query_phpselect , $development) or die(mysql_error());
...
$dbselect  = mysql_query($query_dbselect , $development) or die(mysql_error());
...
$tableselect  = mysql_query($query_tableselect , $development) or die(mysql_error());
...
$summary  = mysql_query($query_summary , $development) or die(mysql_error());
...
<table width="50%" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td>
      <table>
        <form name="formphp" id="formphp" method="post" action="../Development/DevPhpDbAddPop.php?phpdb=<?php echo $_GET['phpdb']; ?>">  
        <tr>
          <td>Folder:</td>
          <td>php file:</td>
    ...
    <td>
      <table>
        <form name="formdb" id="formdb" method="get" action="../Development/DevPHPdbAddPop.php">  
        <tr>
          <td>DB:</td>
          <td>Table:</td>
          <td>&nbsp;</td>
