...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $Result1 = mysql_query($insertSQL, $development) or die(mysql_error());
	...
	mysql_select_db($database_development, $development);   // find the receipt number
	$query_maxid = "SELECT MAX(id) mxid from development";  
	$maxid = mysql_query($query_maxid, $development) or die(mysql_error());
...
?>
  ...
  <tr>
    <td>&nbsp;</td>
    <td> <a href="../Development/DevTrackSum.php">Close </a></td>
    <td>&nbsp;</td>
