...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $development) or die(mysql_error());
...
$DEVLIST = mysql_query($query_DEVLIST, $development) or die(mysql_error());
...
?>
<?php mysql_select_db($database_development, $development);
$query_projid = "SELECT id, projname, projversion FROM devproject ORDER BY id ASC";
$projid = mysql_query($query_projid, $development) or die(mysql_error());
...
$folderphp = mysql_query($query_folderphp, $development) or die(mysql_error());
...
$dbtable = mysql_query($query_dbtable, $development) or die(mysql_error());
...
Required    </td>
  ...
  <tr>
    ...
    <br />Live</td>
		<td title="Select from a list of previously entered folder-phpfile&#10;If desired file is not on the list, use Add New below"><a href="javascript:void(0)" onclick="MM_openBrWindow('../Development/DevPhpDbAddPop.php?phpdb=<?php echo $row_DEVLIST['id']; ?>','StatusView','scrollbars=yes,resizable=yes,width=900,height=250')">Add(Select) Folder/File or db/table</a></td>
  <td rowspan="2" valign="top">
    <table border="1" cellpadding="1" cellspacing="1"style="border-collapse:collapse;">
      ...
      <?php do { ?>
        <tr>
        	<td title="Delete is IMMEDIATE!!&#10; No confirmation is provided!"><a href="../Development/DevPhpdbDelete.php?delid=<?php echo $row_folderphp['id']; ?>&amp;devid=<?php echo $row_DEVLIST['id']; ?>">Del</a></td>
  ...
  <td colspan="2" rowspan="2" valign="top">
    <table border="1" cellpadding="1" cellspacing="1">
      ...
      <?php do { ?>
        <tr>
        	<td title="Delete is IMMEDIATE!!&#10; No confirmation is provided!"><a href="../Development/DevPhpdbDelete.php?delid=<?php echo $row_dbtable['id']; ?>&amp;devid=<?php echo $row_DEVLIST['id']; ?>">Del</a></td>
  ...
  <tr>
		<td title="Add a NEW folder/file OR db/table to &#10;selection list and for this dev item"><a href="javascript:void(0)" onclick="MM_openBrWindow('../Development/DevPhpDbNewPop.php?phpdb=<?php echo $row_DEVLIST['id']; ?>','StatusView','scrollbars=yes,resizable=yes,width=900,height=250')">Add (New)  Folder/File or db/table</a></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="4" nowrap="nowrap"> <a href="../Development/DevTrackSum.php">Close </a></td>
    <td colspan="2">&nbsp;</td>
...
<tr>
    <td valign="top"><div align="right"><strong>Comments</strong></div>
    				<div align="center" class="navLink"><a href="javascript:void(0)" onclick="MM_openBrWindow('../Development/DevCommAdd.php?id=<?php echo $row_DEVLIST['id']; ?>','StatusView','scrollbars=yes,resizable=yes,width=600,height=300')">ADD</a></div>
	</td>
