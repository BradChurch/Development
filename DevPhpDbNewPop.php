...
<table width="50%" border="1" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td>
      <table>
        <form name="formphp" id="formphp" method="post" action="../Development/DevPhpDbNewPop.php?phpdb=<?php echo $_GET['phpdb']; ?>">  
          <tr>
    ...
    <td>
      <table>
        <form name="formdb" id="formdb" method="post" action="../Development/DevPhpDbNewPop?phpdb=<?php echo $_GET['phpdb']; ?>.php">  
          <tr>
