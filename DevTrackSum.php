...
$DevSumList = mysql_query($query_DevSumList, $development) or die(mysql_error());
...
<form name="formdev" method="post" id="formdev" action="DevTrackSum.php" >  
  <tr>
    <td>&nbsp;</td>
    <td><a href="../Jiloa/Setup/SetUpMenu.php">Setup Menu </a></td>
    <td nowrap="nowrap" ><a href="../Development/DevProjectView.php">Project List</a></td>
    <td>&nbsp;</td>
...
<table align="center">
  <tr>
    ...
    <td><a href="../Development/DevTrackAdd.php">ADD</a></td>
    <td>&nbsp;</td>
    <?php  } else {?>
    <td>&nbsp;</td>
    <?php }?>
...
<!--SORT by Assigned TO-->
    ...
    <td align="center" nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="DevTrackSum.php?SORT=id&assignedto=<?php echo $colname_assignedto ?>&projid=<?php echo $colname_projid ?>&status=<?php echo $colname_status ?>&Priority=<?php echo $colname_priority ?>&DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">Task &#8595<br />
      id</td>
          <td nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=AssignedTo&amp;assignedto=<?php echo $colname_assignedto ?>&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">Assigned &#8595;<br />To</a></div></td>

<!--SORT by Status-->            
         <td nowrap="nowrap"  class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=status&amp;assignedto=<?php echo $colname_assignedto ?>&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">Status &#8595;</a></div></td>
         
<!--SORT by Priority-->            
    <td nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=Priority&amp;assignedto=<?php echo $colname_assignedto ?>&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">&nbsp;&nbsp;Pri- &#8595;<br />
      ority</a></div></td>
      
<!--SORT by DevType-->            
    <td nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=DevType&amp;assignedto=<?php echo $colname_assignedto ?>&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">&nbsp;&nbsp;Dev   &#8595;<br />
      Type</a></div></td>
      
<!--SORT by Priority-->            
    <td nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=EstHrs&amp;assignedto=<?php echo $colname_assignedto ?>&amp;SORT=Priority&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">&nbsp;&nbsp;Est   &#8595;<br />
      Hrs</a></div></td>
      
<!--SORT by ActHours-->            
    <td nowrap="nowrap" class="flagWhiteonBlue"><div align="center"><a href="../Development/DevTrackSum.php?SORT=ActHrs&amp;assignedto=<?php echo $colname_assignedto ?>&amp;projid=<?php echo $colname_projid ?>&amp;status=<?php echo $colname_status ?>&amp;Priority=<?php echo $colname_priority ?>&amp;DevType=<?php echo $colname_devtype ?>" class="flagWhiteonBlue">&nbsp;&nbsp;Act   &#8595;<br />
      Hrs</a></div></td>
...
<!--  Only Len or Grace can Edit-->
    <?php if(isset($_SESSION['user']) AND stripos($_SESSION['user'],'BRIELSE')> 0 or stripos($_SESSION['user'],'ADMIN')>0) {?>
    <td valign="center" title="Entry Date: <?php echo $row_DevSumList['entrydt'] ?>" bgcolor="<?php echo $bkg; ?>"><a href="../Development/DevTrackEdit.php?id=<?php echo $row_DevSumList['id']; ?>&amp;projid=<?php echo $row_DevSumList['projid']; ?>">EDIT</a></td>
    <?php  } else {?>
    <td>&nbsp;</td>
    <?php }?>
...
if($row_DevSumList['live'] == 'Y') { $bkg="#ccffcc";} ?>
  ...
  <tr bgcolor="<?php echo $bkg; ?>">
    ...
    <td bgcolor="#DCDCDC">&nbsp;</td>
    <td bgcolor="#DCDCDC">&nbsp;</td>
    <td bgcolor="#DCDCDC"><div align="center" class="navLink"><a href="../Development/DevCommAdd.php"><a href="javascript:void(0)" onclick="MM_openBrWindow('DevCommAdd.php?id=<?php echo $row_DevSumList['id'] ?>','StatusView','scrollbars=yes,resizable=yes,width=600,height=300')">ADD</a></div></td>
...
$source = mysql_query($query_source, $development) or die(mysql_error());
$row_source = mysql_fetch_assoc($source);
$totalRows_source = mysql_num_rows($source);
?>
<?php do {   ?>
        <tr>
          <td><a href="../Development/DevCommAdd.php"><a href="javascript:void(0)" onclick="MM_openBrWindow('DevCommEdit.php?id=<?php echo $row_source['id'] ?>','StatusView','scrollbars=yes,resizable=yes,width=600,height=300')"><?php echo $row_source['entrydt'].':'.$row_source['entryby']; ?></a></td>
